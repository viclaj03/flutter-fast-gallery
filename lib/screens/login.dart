...
// Reemplaza la lógica del botón de inicio de sesión con la llamada a la API
        ...
        onPressed: () async {
          if (_formKey.currentState!.validate()) {
            ...
            try {
              ...
              String token = await authenticateUser(emailInput, passwordInput);
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('¡Bienvenido!  $emailInput'), backgroundColor: Colors.green,),
              );
  ...
  Future<String> authenticateUser(String email, String password) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Error de autenticación T.T');
    }
  }
